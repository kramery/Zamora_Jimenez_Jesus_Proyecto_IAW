    ...
    <header>
        <div class="header-content">
            <div class="header-content-inner">
                <h1 id="homeHeading">Iniciar sesión</h1>
                <hr>
            ...
            if ($result->num_rows > 0) {
               ...
               echo "<h3 id='homeHeading'>El usuario o contraseña son incorrectos.</h3>";

               echo "<br><a href='../sesion'><h3 id='homeHeading'>Volver a Intentarlo</a></h3>";
             }
