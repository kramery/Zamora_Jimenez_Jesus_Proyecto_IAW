...
INSERT INTO `aves` VALUES (1,'Bowie','verde','amazonas','jsus366_2015-11-03_12-48-47.jpg',NULL);
...
INSERT INTO `usuarios` VALUES (1,'Jesus','Zamora','España','Sevilla','jsus365@gmail.com','prueba','admin'),(3,'Pepa','Pig','Francia','Lyon','pepa@pepa.com','pepa','usuario'),(4,'Pedro','vargas','espaÃ±a','salamanca','pedro@pedro.com','pedro','usuario'),(5,'juan','Jimenez-Castellanos','EspaÃ±a','Sevilla','juanjccarmona@gmail.com','contrasenajuan','usuario'),(52,'admin','admin','admin','admin','admin@admin','admin','administrador'),(68,'user','user','user','user','user@user.com','user','usuario'),(8877,'mercedes','gonzalez','espana','sevilla','mervisco@gmail.com','mercedes','Usuario'),(42410,'irene','csdc','dcsdc','sdcsc','irene@irene.com','irene','Administrador'),(651654,'Jaime','zamora','espaa','sevilla','admin@gmail.com','Candela*65','usuario');
...
-- Dump completed on 2017-01-27  1:40:24
